(function () {
  ...
  async function initAuth() {
    if (window.__skillsAuthReady) return window.__skillsAuthReady;

    window.__skillsAuthReady = (async () => {
    ...
    try {
      return await window.__skillsAuthReady;
    } catch (e) {
      window.__skillsAuthReady = null;
      throw e;
    }
