...
<body><iframe src="${blobUrl}" title="${safeTitle}"></iframe></body>
  ...
  function renderPagination(pageData){
    ...
    prev.innerHTML = `<svg viewBox="0 0 24 24" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="ns-icon-use"><use href="/novoskill_icons.svg#ns-icon-legacy-24b9971b5c72"></use></svg>`;
    ...
    next.innerHTML = `<svg viewBox="0 0 24 24" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="ns-icon-use"><use href="/novoskill_icons.svg#ns-icon-legacy-0ba498c7ae0a"></use></svg>`;
