...
from app.routers import studio_portal_auth, studio_portal_dashboard, studio_portal_data, studio_portal_organisation, studio_portal_catalog_postes, studio_portal_catalog_competences
