(function () {
    ...
    if (!r.ok) {
      throw new Error(
        (data && (data.detail || data.message))
          ? (data.detail || data.message)
          : "Mot de passe enregistrÃ©, mais activation des accÃ¨s Partner impossible."
      );
    }
  ...
  async function updatePassword() {
    ...
    try {
      ...
      setMsg("Mot de passe mis Ã  jour. Tes accÃ¨s Partner sont actifs. Tu peux te reconnecter.", "success");
