...
@router.post("/learn/auth/activate")
def learn_auth_activate(request: Request):
    """
    Active les accès Novoskill après création / réinitialisation du mot de passe depuis Learn.
