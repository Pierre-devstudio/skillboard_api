...
def get_analyse_matching_poste_pdf(
    ...
    try:
        ...
        meta = Table([
            [Paragraph("Périmètre", styles["meta_label"]), Paragraph(safe(perimetre), styles["meta_value"]), Paragraph("Criticité", styles["meta_label"]), Paragraph(f"≥ {int(criticite_min)}", styles["meta_value"])],
