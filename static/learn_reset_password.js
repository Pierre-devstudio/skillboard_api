(function () {
    ...
    if (!r.ok) {
      throw new Error(
        (data && (data.detail || data.message))
          ? (data.detail || data.message)
          : "Mot de passe enregistré, mais activation des accès Learn impossible."
      );
    }
  ...
  async function updatePassword() {
    ...
    try {
      ...
      setMsg("Mot de passe mis à jour. Tes accès Learn sont actifs. Tu peux te reconnecter.", "success");
