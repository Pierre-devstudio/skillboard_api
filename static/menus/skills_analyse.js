...
(function () {
  ...
  function analyseEyeIconSvg() {
    return `<svg viewBox="0 0 24 24" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="ns-icon-use"><use href="/novoskill_icons.svg#ns-icon-user"></use></svg>`;
  }

  function analysePdfIconSvg() {
    return `<svg viewBox="0 0 24 24" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="ns-icon-use"><use href="/novoskill_icons.svg#ns-icon-legacy-b917bd60dcf2"></use></svg>`;
  }
  ...
  function analyseDetailIconSvg(kind) {
    const icons = {
      risques: `<svg viewBox="0 0 24 24" class="ns-icon-use"><use href="/novoskill_icons.svg#ns-icon-eye"></use></svg>`,
      matching: `<svg viewBox="0 0 24 24" class="ns-icon-use"><use href="/novoskill_icons.svg#ns-icon-network"></use></svg>`,
      previsions: `<svg viewBox="0 0 24 24" class="ns-icon-use"><use href="/novoskill_icons.svg#ns-icon-legacy-a61837ee7177"></use></svg>`,
      ...
      matchingPostes: `<svg viewBox="0 0 24 24" class="ns-icon-use"><use href="/novoskill_icons.svg#ns-icon-network"></use></svg>`,
      candidats: `<svg viewBox="0 0 24 24" class="ns-icon-use"><use href="/novoskill_icons.svg#ns-icon-legacy-7b2980eb4a79"></use></svg>`,
      sortiesConfirmees: `<svg viewBox="0 0 24 24" class="ns-icon-use"><use href="/novoskill_icons.svg#ns-icon-legacy-ceb362be1bd5"></use></svg>`,
      sortiesPotentielles: `<svg viewBox="0 0 24 24" class="ns-icon-use"><use href="/novoskill_icons.svg#ns-icon-legacy-293cf2031edc"></use></svg>`,
      transmissions: `<svg viewBox="0 0 24 24" class="ns-icon-use"><use href="/novoskill_icons.svg#ns-icon-eye"></use></svg>`
    };
    ...
    return `
      <div style="display:flex; flex-direction:column; align-items:center; gap:6px;">
        <div style="position:relative; width:${size}px; height:${size}px;">
          <svg width="${size}" height="${size}" viewBox="0 0 ${size} ${size}" aria-hidden="true" style="position:absolute; inset:0;" class="ns-icon-use"><use href="/novoskill_icons.svg#ns-icon-legacy-b971fe340bf0"></use></svg>
    ...
    return `
      <div class="card sb-prev-ring-card">
        ...
        <div class="sb-prev-ring-visual" style="width:${size}px; height:${size}px; flex-basis:${size}px;">
          <svg width="${size}" height="${size}" viewBox="0 0 ${size} ${size}" aria-hidden="true" class="sb-prev-ring-svg ns-icon-use"><use href="/novoskill_icons.svg#ns-icon-legacy-b971fe340bf0"></use></svg>
  ...
  (async () => {
    try {
      if (rf === "evol-3m") {
        ...
        const eyeIcon = `
          <svg viewBox="0 0 24 24" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="ns-icon-use"><use href="/novoskill_icons.svg#ns-icon-legacy-d89353fe0266"></use></svg>
        `;
