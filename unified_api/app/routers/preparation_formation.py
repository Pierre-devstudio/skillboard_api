...
# -----------------------------
# APP LOCALE (sera branchée dans main.py)
# -----------------------------
app_local = FastAPI(title="Skillboard - Préparation Formation API")

# CORS (en plus du global dans main.py)
ALLOWED_ORIGINS = [
...
# -----------------------------
@app_local.get("/healthz")
async def healthz():
    return {"status": "ok"}


@app_local.head("/healthz")
